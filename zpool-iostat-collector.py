...
SAMPLING_INTERVAL = 60          # Sampling interval in seconds (e.g., 60 for 1-minute samples)
SAMPLING_FREQUENCY = 120        # How often to collect samples in seconds (e.g., 300 = 5 minutes)
